...
void Shop2::Initialize()
{
	AddComponent<Engine::Component::GameObject>()->SetTag(L"Shop2");
	...
	GetComponent<Engine::Component::UI>()->SetBitmapPath(L"..\\Resource/UI_store_level_2_image.png");
